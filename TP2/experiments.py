...
def run_text2img_experiments() -> None:
    model_id = DEFAULT_MODEL_ID
    seed = 42
    prompt = """A new Porsche 911, a high-end luxury sports car with a sleek aerodynamic silhouette,
        low ground clearance, iconic rounded LED headlights, and wide flared rear wheel arches.
        Metallic chalk grey paint with sharp reflections, premium alloy wheels,
        studio lighting with soft rim light, clean minimalist background,
        highly detailed automotive engineering, 8k resolution, masterpiece. """
    negative = "text, watermark, logo, low quality, blurry, deformed"
...
def run_img2img_experiments() -> None:
    ...
    init_path = "inputs/fender.png"  # ex: "my_product.jpg"

    prompt = """The Eiffel Tower made of intricate iron latticework, Paris landmark,
        vertical metal structure, industrial architecture, masterpiece, 8k resolution,
        sharp details, hyper-realistic, blue sky background, dramatic perspective"""   # TODO: prompt e-commerce (en anglais)
    negative = "text, watermark, logo, low quality, blurry, deformed"
